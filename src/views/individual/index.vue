  ...
  <div>
    ...
    <el-tabs >
      <el-tab-pane label="个人信息" >
        <div>
          <el-form ref="infoForm" :rules="formRules" :model="infoForm" label-width="80px" style="width: 500px;">
            <el-form-item v-show="true" label="头像" prop="avatarUrl">
              <el-upload
                ...
                <div slot="tip" class="text-gray text-sm">支持jpg, png格式，文件大小不超过3MB，推荐方形或圆形图片。</div>
      ...
      <el-tab-pane label="修改密码" >
        <div>
          <el-form ref="passwordForm" :rules="formRules" :model="passwordForm" label-width="80px" style="width: 500px;">
