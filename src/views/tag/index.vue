  ...
  <div>
    ...
    <div>
      <el-form ref="queryForm" inline :model="queryParams">
        <el-form-item label="标签名" prop="name">
          <el-input size="medium" v-model="queryParams.name" placeholder="请输入" clearable @keyup.enter.native="tagQuery"></el-input>
        </el-form-item>

        <el-form-item>
          <el-button size="medium" type="primary" icon="el-icon-search" @click="tagQuery" >查询</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <BaseTable 
      ...
      <template slot="columns">
        ...
        <el-table-column prop="name" label="标签名" min-width="120"></el-table-column>
        ...
        <!-- <el-table-column prop="deleted" label="隐藏" min-width="70">
          <template slot-scope="scope">
            <el-switch 
              ...
              :active-value="1" 
              :inactive-value="0"
              @change="tagUpdateDeleted(scope.$index, scope.row)"></el-switch>
          </template>
        </el-table-column> -->
          ...
          <template slot-scope="scope">
            ...
            <div v-else>
              ...
              <el-popconfirm
                ...
                icon-color="red"
                title="永久删除该条数据？"
                @confirm="tagRemove(scope.$index, scope.row)">
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="medium" type="primary" @click="tagSave(addItem)" v-loading="formLoading">确定</el-button>
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="medium" type="primary" @click="tagUpdate(updateIndex, updateItem)" v-loading="formLoading">确定</el-button>
...
import { 
  ...
  adminTagRemove,
  adminTagUpdate,
  adminTagUpdateDeleted } from "@/api/tag.js";
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      try {
        let res = await adminTagPage(params)
    ...
    tagUpdate(index, item) {
      this.$refs["updateForm"].validate((isValid) => {
        if (!isValid) {
          return false
        }
        this.formLoading = true
        adminTagUpdate(item).then(res => {
          this.$message({
            message: res.msg,
            type: 'success'
          });
